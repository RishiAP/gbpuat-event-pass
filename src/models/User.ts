...
export interface IUser extends Document {
    ...
    photo: string|null;
    locked: boolean;
    events: Map<Schema.Types.ObjectId, { status: boolean; seat_no:string; enclosure_no: string; emails_sent:String[], entry_gate:string, entry_time:Date, verifier: Schema.Types.ObjectId, invitation:String, id_card?:string }>;  // Verifier as ObjectId
}
